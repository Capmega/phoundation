...
// Set page meta data
Page::setHeaderTitle(tr('Projects'));
          ...
          <tbody>
              <tr>
                  ...
                  <td class="project-actions text-right">
                      <a class="btn btn-primary btn-sm" href="<?= UrlBuilder::getWww('demos/project-detail.html'); ?>">
              ...
              <tr>
                  ...
                  <td class="project_progress">
                      <div class="progress progress-sm">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="12" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
                          </div>
                      </div>
                      <small>
                          0% Complete
