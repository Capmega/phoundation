...
?>
<body class="hold-transition lockscreen" style="background: url(<?= UrlBuilder::getImg('img/backgrounds/' . Core::getProjectSeoName() . '/fingerprint-screen.jpg') ?>); background-position: center; background-repeat: no-repeat; background-size: cover;">
    <!-- Automatic element centering -->
    <div class="lockscreen-wrapper card card-outline card-info">
        <div class="card-header text-center">
            <div class="lockscreen-logo">
                <a href="<?= Config::getString('project.customer-url', 'https://phoundation.org'); ?>" class="h1"><?= Config::getString('project.owner.label', '<span>Medi</span>web'); ?></a>
            </div>
        </div>
        <div class="card-body">
            <!-- User name -->
