...
if ($object instanceof CoreException) {
    ...
    if (Strings::until($object->getCode(), '/') == 'warning') {
        ...
        if (debug()) {
             ...
             * All CoreExceptions thrown by functions will contain the function name like function():
            ...
            if (preg_match('/^[a-z_]+\(\): /', $params['html']) or preg_match('/PHP ERROR [\d+] /', $params['html'])) {
                ...
                notify(array('code'    => 'exception',
                             ...
                             'message' => tr('html_flash_set(): Received CoreException ":code" with message trace ":trace"', array(':code' => $params['type'], ':trace' => $params['html']))));
    ...
    if (Strings::from($object->getCode(), '/') == 'validation') {
        ...
        if (debug()) {
            ...
            /*
             * Non CoreExceptions basically are caused by PHP and should basically not ever happen.
