...
class Zend_Utf8
{
    ...
    public static function escape(string $value, array $options = array())
    {
        ...
        {
            throw new CoreException('Zend_Utf8::escape(): Expected a valid write (callable, array)', 'invalid');
        }
        ...
        for($i = 0; $i < $length; $i++) {
            ...
            switch (true) {
                ...
                default:
                    ...
                    throw new CoreException('Zend_Utf8::escape(): Expected a valid UTF-8 character', 'invalid');
                break;
            }
        }
    ...
    public static function utf8CharToCodePoint($utf8Char)
    {
        ...
        else
        {
            ...
            switch (strlen($utf8Char))
            {
                ...
                default:
                    //no more cases in unicode, whose range is 0x00000000 - 0x0010FFFF
                    throw new CoreException('Zend_Utf8::utf8CharToCodePoint(): Expected a valid UTF-8 character', 'invalid');
                break;
            }
    ...
    public static function utf8CharToSurrogatePair($utf8Char)
    {
        ...
        {
            throw new CoreException('Zend_Utf8::utf8CharToSurrogatePair(): Expected an extended UTF-8 character', 'invalid');
        }
        $codePoint -= 0x10000;
    ...
    public static function unescape($value, array $options = array())
    {
        ...
        {
            throw new CoreException('Zend_Utf8::unescape(): Expected a valid read (callable, array)', 'invalid');
        }
        ...
        while (preg_match($pattern, $value, $matches, 0, $offset))
        {
            ...
            else
            {
                ...
                if ($options['extendedUseSurrogate'] && (0xD800 <= $unicode && $unicode < 0xDC00))
                {
                    ...
                    if (! $matches[2])
                    {
                        throw new CoreException('Zend_Utf8::unescape(): Expected an extended UTF-8 character', 'invalid');
                    }
                    $offset += strlen($matches[0]);
                    $args = array_splice($matches, 2, count($matches) - 1);
    ...
    public static function utf8CharFromCodePoint($codePoint)
    {
        ...
        {
            //reserved for UTF-16 surrogates
            throw new CoreException('Zend_Utf8::utf8CharFromCodePoint(): Expected a valid code point', 'invalid');
        }
    ...
    public static function utf8CharFromSurrogatePair($surrogatePair)
    {
        ...
        {
            throw new CoreException('Zend_Utf8::utf8CharFromSurrogatePair(): Expected an extended UTF-8 character', 'invalid');
        }
    ...
    protected static function validateFilters($options)
    {
        if (isset($options['filters']))
        {
            ...
            {
                throw new CoreException('Zend_Utf8::validateFilters(): Expected valid filters', 'invalid');
            }
