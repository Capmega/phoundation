...
// * Framework version
// */
//define('Core::FRAMEWORKCODEVERSION', '3.0.6');
...
//                throw new CoreException(tr('CoreException::addMessages(): Only supported object class to add to messages is CoreException'), 'invalid');
//            }
//
...
// * /code
// *
// * @param params Error Exception CoreException $params The notification parameters, or an Exception / Error / CoreException object
...
//                 * load them again
//                 */
//                notify(new CoreException(tr('load_libs(): Library ":library" was already loaded during system startup, not loading again', array(':library' => $library)), 'warning/already-done'));
//                continue;
//            }
//
...
//    }catch(Error $e) {
//        if (isset($library)) {
//            $e = new CoreException(tr('load_libs(): Failed to load library ":library"', array(':library' => $library)), $e);
//
//        } else {
//            $e = new CoreException(tr('load_libs(): Failed to load libraries ":libraries"', array(':libraries' => $libraries)), $e);
//        }
//
...
//            $this->foreground_colors['CoreException']   = '1;31';
