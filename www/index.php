 ...
 * X$PATHS$         Restrict access to the specified dot-comma separated $PATHS$ list. $PATHS is optional and defaults to DIRECTORY_WEB, DIRECTORY_DATA . 'content/downloads'
 *
...
Route::try('/^(\w{2})\/([a-z0-9-\/]+)\/([a-z]+)(\.([0-9a-z-]+))?.html$/', 'pages/$2/$3.php?id=$4');            // Show the requested form page
