...
class Modal extends \Phoundation\Web\Http\Html\Components\Modal
{
   /**
    ...
    public function render(): ?string
    {
        ...
        $this->render = '   <div class="modal' . ($this->fade ? ' fade' : null) . '" id="' . $this->id . '" tabindex="' . $this->getTabIndex() . '" aria-labelledby="' . $this->id . 'Label" aria-hidden="true" data-mdb-keyboard="' . ($this->escape ? 'false' : 'true') . '" data-mdb-backdrop="' . ($this->backdrop === null ? 'static' : Strings::boolean($this->backdrop)) . '">
