...
class Restrictions implements RestrictionsInterface
{
     ...
     *                                                              class, but as a directory string, or array of
     *                                                              directory strings, then this method will convert
     *                                                              that into a Restrictions object and this is the
     *                                                              $write modifier for that object
     * @param string|null                             $label        If $restrictions is not specified as a Restrictions
     *                                                              class, but as a directory string, or array of
     *                                                              directory strings, then this method will convert
     *                                                              that into a Restrictions object and this is the
     *                                                              $label modifier for that object
     *
