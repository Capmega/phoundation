...
/**
 * Command audio warning
 *
 * This command plays the warning audio file on the local machine
 *
...
CliDocumentation::setHelp('This command plays the warning audio file on the local machine.
...
Log::information(ts('Playing audio file "warning"'), 10);
Audio::new('warning.mp3')->playLocal($argv['background']);
