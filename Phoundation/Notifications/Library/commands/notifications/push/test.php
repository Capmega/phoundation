...
$argv  = ArgvValidator::new()
                      ...
                      ->select('-e,--emergency', true)->isOptional()->xor('users')->hasMaxCharacters(2048)->sanitizeForceArray()->forEachField()->isVariable()
    ->validate();
...
Log::success(ts('Sent out ":count" test notifications', [':count' => $count]), 10);
