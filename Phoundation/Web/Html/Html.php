...
use Phoundation\Web\Http\Html\DOMDocument;
use Stringable;
use Throwable;
use function Phoundation\Web\Http\Html\accepts;
use function Phoundation\Web\Http\Html\array_ensure;
use function Phoundation\Web\Http\Html\array_implode_with_keys;
use function Phoundation\Web\Http\Html\array_params;
use function Phoundation\Web\Http\Html\cdn_domain;
use function Phoundation\Web\Http\Html\cli_unzip;
use function Phoundation\Web\Http\Html\debug_bar;
use function Phoundation\Web\Http\Html\domain;
use function Phoundation\Web\Http\Html\file_delete;
use function Phoundation\Web\Http\Html\file_move_to_target;
use function Phoundation\Web\Http\Html\gettype;
use function Phoundation\Web\Http\Html\html_favicon;
use function Phoundation\Web\Http\Html\html_generate_css;
use function Phoundation\Web\Http\Html\html_generate_js;
use function Phoundation\Web\Http\Html\html_img;
use function Phoundation\Web\Http\Html\html_img_src;
use function Phoundation\Web\Http\Html\html_load_js;
use function Phoundation\Web\Http\Html\html_meta;
use function Phoundation\Web\Http\Html\html_og;
use function Phoundation\Web\Http\Html\html_safe;
use function Phoundation\Web\Http\Html\html_script;
use function Phoundation\Web\Http\Html\html_select;
use function Phoundation\Web\Http\Html\html_select_body;
use function Phoundation\Web\Http\Html\html_tabindex;
use function Phoundation\Web\Http\Html\image_convert;
use function Phoundation\Web\Http\Html\load_config;
use function Phoundation\Web\Http\Html\load_libs;
use function Phoundation\Web\Http\Html\log_console;
use function Phoundation\Web\Http\Html\log_file;
use function Phoundation\Web\Http\Html\Notification;
use function Phoundation\Web\Http\Html\set_csrf;
use function Phoundation\Web\Http\Html\sql_fetch;
use function Phoundation\Web\Http\Html\sql_get;
use function Phoundation\Web\Http\Html\str_random;
use function Phoundation\Web\Http\Html\str_truncate;
use function Phoundation\Web\Http\Html\uglify_js;
use function Phoundation\Web\Http\Html\under_construction;
            ...
            try {
                ...
                if (file_exists($file.'.js')) {
                    if (!filesize($file.'.js')) {
                        ...
                        File::new()->executeMode(DIRECTORY_ROOT.'www/'.LANGUAGE.'/pub/js', 0770, function() use ($file) {
