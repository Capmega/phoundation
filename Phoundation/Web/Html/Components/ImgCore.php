 ...
 * Class ImgCore
 *
 * This class contains the core methods for the Img object
 *
...
class ImgCore extends SpanCore implements ImgInterface
{
    /**
    ...
    public function setLazyLoad(?bool $lazy_load): static
    {
        ...
        if ($lazy_load) {
            ...
            Response::loadJavascript('phoundation/phoundation/jquery/lazyload/jquery.lazyload');
        }
    ...
    /**
     * Returns an image file object for this image.
     *
     * NOTE: If this image is external (so not on this server) an exception will be thrown
     *
     * @return ImageFileInterface
     */
    public function getImageFileObject(): ImageFileInterface
    {
        return ImageFile::new();
    }
...
//        }
    ...
    {
        if (!$this->src) {
            throw new HtmlException(tr('Cannot render img tag, no src attribute specified'));
        }

        if (!$this->alt) {
            throw new HtmlException(tr('Cannot render img tag, no alt attribute specified'));
        }
