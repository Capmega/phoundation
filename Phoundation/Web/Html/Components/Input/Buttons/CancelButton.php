...
class CancelButton extends Button
{
    ...
    {
        return config()->getArray('platforms.web.html.components.buttons.cancel.modifier-keys', ['ctrl', 'alt']);
    }
    ...
    {
        return config()->getBoolean('platforms.web.html.components.buttons.cancel.outlined', true);
    }
    ...
    {
        return EnumDisplayMode::tryFrom(config()->getString('platforms.web.html.components.buttons.cancel.mode', 'warning'));
    }
}
