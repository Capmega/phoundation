...
use Phoundation\Web\Html\Components\Tooltips\Enums\EnumTooltipBoundary;
use Phoundation\Web\Html\Components\Tooltips\Enums\EnumTooltipPlacement;
use Phoundation\Web\Html\Components\Tooltips\Enums\EnumTooltipTrigger;
...
class Tooltip extends Element implements TooltipInterface
{
    ...
    public function render(?string $render = null): ?string
    {
        ...
        if ($this->use_icon) {
            ...
            $this->source_element->getData()->merge($this->data);
        }
