...
JsonPage::new()
        ...
        ->addFlashMessageSections(FlashMessage::new()
                                              ...
                                              ->setTitle(tr('Service Unavailable'))
                                              ->setMessage(tr('The server is under maintenance and will return momentarily. Please contact your system administrator for more information')))
