 ...
 * Page setup
 *
 * This is the setup page that will be displayed if the project file is missing
 *
 * The project file is located in config/project/name and contains ONLY the project name, nothing more.
 *
...
if (array_get($get, 'no_password_validation')) {
        ...
        <div class="register-box">
            ...
            <div class="card">
                <div class="card-body register-card-body">
                    ...
                    <hr>
                    <p class="login-box-msg">The setup of your Phoundation system has now finished. Please click below
                        to start using it!</p>
                    <hr>
                    <div class="mb-3">
    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <hr>
                <p class="login-box-msg">Phoundation requires a simple setup process to get it running. Please fill out
                ...
                <form action="<?= Request::getUrl() ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="admin_email" type="email" class="form-control"
                               placeholder="Administrator email address" value="<?= array_get($post, 'admin_email') ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input name="admin_pass2" type="password" class="form-control"
                               placeholder="Verify administrator password">
                    </div>
                    <div class="mb-3">
                        <input name="project" type="text" class="form-control" placeholder="Project name"
                               value="<?= array_get($post, 'project', 'phoundation') ?>">
                    </div>
                    <div class="mb-3">
                        <select name="environment" type="text" class="form-control">
                            <option value="">Select an environment</option>
                            <option<?= (array_get($post, 'environment') ? ' selected' : null) ?> value="local">Local
                            </option>
                            <option<?= (array_get($post, 'environment') ? ' selected' : null) ?> value="public_trial">
                                Public trial
                            </option>
                            <option<?= (array_get($post, 'environment') ? ' selected' : null) ?> value="private_trial">
                                Private trial
                            </option>
                            <option<?= (array_get($post, 'environment') ? ' selected' : null) ?> value="Production">
                                Production
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        <input name="database_pass2" type="password" class="form-control"
                               placeholder="Verify database user password">
                    </div>
                    <hr>
                    <p class="login-box-msg"><b>NOTE:</b> The setup may take various seconds to minutes. Please wait
                        patiently and check Phoundation logs for more information during setup.</p>
                    <hr>
                    <div class="mb-3">
