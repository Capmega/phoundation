...
CliDocumentation::setUsage('./pho cache dump keys -c session');

CliDocumentation::setHelp('This command will dump all keys available in cache for the specified connector 
to STDOUT
...
-c, --connector CONNECTOR_NAME          The cache connector to use');
