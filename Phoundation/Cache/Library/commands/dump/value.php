...
CliDocumentation::setHelp('This command will dump the value for the specified key from the specified cache connector to 
STDOUT
...
try {
    ...
    $value = cache($argv['connector'])->exists($argv['key']);
