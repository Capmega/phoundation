...
trait TraitDataEntryTimezone
{
    ...
    {
        return $this->getSourceValueTypesafe('int', 'timezones_id');
    }
    ...
    {
        $timezones_id = $this->getSourceValueTypesafe('int', 'timezones_id');
    ...
    {
        return $this->getSourceValueTypesafe('string', 'timezones_name');
    }
