...
trait DataEntryCustomer
{
    ...
    {
        return $this->getSourceFieldValue('int', 'customers_id');
    }
    ...
    {
        $customers_id = $this->getSourceFieldValue('int', 'customers_id');
    ...
    {
        return $this->getSourceFieldValue('string', 'customers_name');
    }
