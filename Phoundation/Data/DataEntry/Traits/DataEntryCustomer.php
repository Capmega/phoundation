...
trait DataEntryCustomer
{
    ...
    {
        return $this->getSourceColumnValue('int', 'customers_id');
    }
    ...
    {
        $customers_id = $this->getSourceColumnValue('int', 'customers_id');
    ...
    {
        return $this->getSourceColumnValue('string', 'customers_name');
    }
