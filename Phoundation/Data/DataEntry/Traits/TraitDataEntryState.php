...
trait TraitDataEntryState
{
    ...
    {
        return $this->getSourceValueTypesafe('int', 'states_id');
    }
    ...
    {
        $states_id = $this->getSourceValueTypesafe('int', 'states_id');
    ...
    {
        return $this->getSourceValueTypesafe('string', 'states_name');
    }
