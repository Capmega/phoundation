...
trait DataEntryCompany
{
    ...
    {
        return $this->getSourceValueTypesafe('int', 'companies_id');
    }
    ...
    {
        $companies_id = $this->getSourceValueTypesafe('int', 'companies_id');
    ...
    {
        return $this->getSourceValueTypesafe('string', 'companies_name');
    }
