...
trait DataEntryVersion
{
    ...
    {
        return $this->getSourceFieldValue('string', 'seo_version');
    }
    ...
    {
        return $this->getSourceFieldValue('string', 'version');
    }
    ...
    public function setVersion(?string $version): static
    {
        if ($version === null) {
            ...
            $seo_version = Seo::unique(substr($version, 0, $this->definitions->get('version')->getMaxlength()), static::getTable(), $this->getSourceFieldValue('int', 'id'), 'seo_version');
