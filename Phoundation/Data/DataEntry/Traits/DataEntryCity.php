...
trait DataEntryCity
{
    ...
    {
        return $this->getSourceValue('int', 'cities_id');
    }
    ...
    {
        $cities_id = $this->getSourceValue('int', 'cities_id');
    ...
    {
        return $this->getSourceValue('string', 'cities_name') ?? City::new($this->getCitiesId(), 'id')?->getName();
    }
