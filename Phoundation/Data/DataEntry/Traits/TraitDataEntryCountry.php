...
trait TraitDataEntryCountry
{
    ...
    {
        return $this->getSourceValueTypesafe('int', 'countries_id');
    }
    ...
    {
        $countries_id = $this->getSourceValueTypesafe('int', 'countries_id');
    ...
    {
        return $this->getSourceValueTypesafe('string', 'countries_name');
    }
