...
class DefinitionFactory
{
    ...
    public static function newCategoriesId(?string $column = 'categories_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ->setOutput(function (DefinitionInterface $_definition, string $key, string $column_name, array $source) use ($filters) {
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    // Ensure categories id exists and that it is or category
                                    $_validator->orColumn('categories_name')
                                              ->isDbId()
    ...
    public static function newCategory(?string $column = 'categories_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             ...
                             $_validator->orColumn('categories_id')
                                       ->isName()
    ...
    public static function newServersId(?string $column = 'servers_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    ...
                                    $_validator->orColumn('servers_name')
                                              ->isDbId()
                                              ->isQueryResult('SELECT `id` 
                                                               FROM   `servers` 
                                                               WHERE  `id` = :id
    ...
    public static function newServer(?string $column = 'servers_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure server exists and that it is a server id or server name
    ...
    public static function newCompaniesId(?string $column = 'companies_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setLabel(tr('Company'))
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    // Ensure companies id exists and that it is or company
                                    $_validator->orColumn('companies_name')
                                              ->isDbId()
                                              ->isQueryResult('SELECT `id` 
    ...
    public static function newCompany(?string $column = 'companies_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure the company exists and that it is or company
                             $_validator->orColumn('companies_id')
                                       ->isName()
    ...
    public static function newLanguagesId(?string $column = 'languages_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->orColumn('languages_name')
                                              ->isDbId()
                                              ->isQueryResult('SELECT `id` 
                                                               FROM   `core_languages` 
                                                               WHERE  `id` = :id 
    ...
    public static function newLanguagesName(?string $column = 'languages_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure language exists and that it is or language
                             $_validator->orColumn('languages_id')
    ...
    public static function newProvidersId(?string $column = 'providers_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    // Ensure providers id exists and that it is or provider
                                    $_validator->orColumn('providers_name')
                                              ->isDbId()
                                              ->isQueryResult('SELECT `id` 
    ...
    public static function newProvider(?string $column = 'providers_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure provider exists and that it is providers id or providers name
                             $_validator->orColumn('providers_id')
                                       ->isName()
    ...
    public static function newCustomersId(?string $column = 'customers_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    // Ensure customers id exists and that it is or customer
                                    $_validator->orColumn('customers_name')
                                              ->isDbId()
                                              ->isQueryResult('SELECT `id` 
    ...
    public static function newCustomer(?string $column = 'customers_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure customer exists and that it is or customer
                             $_validator->orColumn('customers_id')
                                       ->isName()
    ...
    public static function newTimezonesId(?string $column = 'timezones_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->orColumn('timezones_name')
    ...
    public static function newTimezonesName(?string $column = 'timezones_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure timezone exists and that it is or timezone
                             $_validator->orColumn('timezones_id')
                                       ->orColumn('timezones_code')
                                       ->isName()
    ...
    public static function newCountriesId(?string $column = 'countries_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setLabel(tr('Country'))
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->orColumn('countries_name')
    ...
    public static function newCountriesName(?string $column = 'countries_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure country exists and that it is or countries_id
                             $_validator->orColumn('countries_id')
                                       ->orColumn('countries_code')
                                       ->isName()
    ...
    public static function newStatesId(?string $column = 'states_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setLabel(tr('State'))
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->orColumn('states_name')
    ...
    public static function newStatesName(?string $column = 'states_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure state exists and that it is or states_id
                             $_validator->orColumn('states_id')
                                       ->orColumn('states_code')
                                       ->isName()
    ...
    public static function newCitiesId(?string $column = 'cities_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setLabel(tr('City'))
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->orColumn('cities_name')
    ...
    public static function newCitiesName(?string $column = 'cities_name'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             // Ensure city exists and that it is or cities_id
                             $_validator->orColumn('cities_id')
                                       ->orColumn('cities_code')
                                       ->isName()
    ...
    public static function newUsersId(?string $column = 'users_id', ?array $filters = null): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setSize(3)
                                ->setCliAutoComplete(true)
                                ->setOutput(function (DefinitionInterface $_definition, string $key, string $column_name, array $source) use ($filters, $column) {
                                    return Users::new()
                                                ->getHtmlSelectOld()
                                                ->setId($column)
                                                ->setName($column)
                                ...
                                ->addValidationFunction(function (ValidatorInterface $_validator) use ($column) {
                                    $_validator->isDbId()
                                              ->isQueryResult('SELECT `id` 
                                                               FROM   `accounts_users` 
                                                               WHERE  `id` = :id 
    ...
    public static function newPath(?PhoDirectoryInterface $exists_in_directory = null, ?string $column = 'path'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->setInputType(EnumInputType::text)
                         ->setCliAutoComplete(true)
                         ->addValidationFunction(function (ValidatorInterface $_validator) use ($exists_in_directory) {
                             if ($exists_in_directory) {
                                 $_validator->isPath($exists_in_directory);
                             }
                         });
    }
    ...
    public static function newFile(?PhoDirectoryInterface $exists_in_directory = null, ?string $column = 'file'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) use ($exists_in_directory) {
                             if ($exists_in_directory) {
                                 $_validator->isFile($exists_in_directory);
                             }
                         });
    }
    ...
    public static function newPhones(?string $column = 'phones'): DefinitionInterface
    {
        return Definition::new($column)
                         ...
                         ->addValidationFunction(function (ValidatorInterface $_validator) {
                             ...
                             // $_validator->sanitizeForceArray(',')->forEachField()->isPhoneNumber()->sanitizeForceString()
                         });
    }
    ...
    public static function newCreatedBy(?string $column = 'created_by'): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setInputType(EnumInputType::dbid)
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->existsInDatabase(tr('must be an existing user'), column: 'id', table: 'accounts_users');
                                })
                                ->setOutput(function (DefinitionInterface $_definition, string $key, string $column_name, array $source) {
                                    if ($_definition->getDataEntryObject()->isNew()) {
    ...
    public static function newModifiedBy(?string $column = 'modified_by'): DefinitionInterface
    {
        return DefinitionFactory::newDatabaseId($column)
                                ...
                                ->setInputType(EnumInputType::dbid)
                                ->addValidationFunction(function (ValidatorInterface $_validator) {
                                    $_validator->existsInDatabase(tr('must be an existing user'), table: 'accounts_users');
                                })
                                ->setOutput(function (DefinitionInterface $_definition, string $key, string $column_name, array $source) {
                                    if ($_definition->getDataEntryObject()->isNew()) {
                                        // This is a new DataEntry object, so the creator is.. Well, you!
