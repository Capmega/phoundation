...
class Device extends PhoFile
{
    ...
    public function luksAddKey(string $code): static
    {
        ...
        Process::new('cryptsetup', $this->_restrictions)
               ->appendArguments(['luksAddKey', $this->source])
               ->setSudo(true)
               ->setPipeFrom($code)
               ->executeNoReturn();
    ...
    public function luksRemoveKey(string $code): static
    {
        ...
        Process::new('cryptsetup', $this->_restrictions)
               ->appendArguments(['luksRemoveKey', $this->source])
               ->setSudo(true)
               ->setPipeFrom($code)
               ->executeNoReturn();
    ...
    public function luksGetDump(): IteratorInterface
    {
        ...
        return Process::new('cryptsetup', $this->_restrictions)
                      ->appendArguments(['luksDump', $this->source])
                      ->setSudo(true)
    ...
    public function luksFormat(string $password, EnumExecuteMethod $method = EnumExecuteMethod::noReturn): static
    {
        ...
        Process::new('cryptsetup', $this->_restrictions)
               ->appendArguments(['luksFormat', '--batch-mode', $this->source])
               ->setSudo(true)
    ...
    public function luksGetStatus(?string $device_name = null): IteratorInterface
    {
        ...
        return Process::new('cryptsetup', $this->_restrictions)
                      ->appendArguments(['status', $device_name])
                      ->setSudo(true)
                      ->executeReturnIterator(':');
    }
    ...
    public function isLuks(): bool
    {
        ...
        $result = Process::new('cryptsetup', $this->_restrictions)
               ->appendArguments(['isLuks', $this->source])
               ->setSudo(true)
               ->executeReturnString();
    ...
    public function luksGetUuid(): string
    {
        ...
        return Process::new('cryptsetup', $this->_restrictions)
               ->appendArguments(['luksUUID', $this->source])
               ->setSudo(true)
               ->executeReturnString();
    }
    ...
    public function luksClose(bool $force = false): static
    {
        ...
        try {
            Process::new('cryptsetup', $this->_restrictions)
                ->appendArguments(['luksClose', $this->device_name])
                ->setSudo(true)
                ->executeNoReturn();
