 ...
 *
 * This exception is thrown when trying to connect to an SQL server that is not available and cannot respond
 *
...
class SqlConnectionTimedOutException extends SqlException
{
}
