            ...
            if (PLATFORM_WEB) {
                ...
                if (is_scalar($value)) {
                    $return .= ($quiet ? '' : tr('DEBUG SHOW (:file@:line) [:type :size] ', [
                        ...
                        ])) . Strings::log($value, ensure_visible: true, clean: false) . PHP_EOL;
        ...
        $html .= '      <table style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>' . tr(':time milliseconds', [':time' => number_format((microtime(true) - STARTTIME) * 1000, 2)]) . '</td>
                            </tr>
                            <tr>
                                <td>' . tr('CPU usage system') . '</td>
                                <td>' . tr(':time microseconds', [':time' => number_format($usage['ru_stime.tv_usec'], 0, ' . ', ',')]) . '</td>
                            </tr>
                            <tr>
