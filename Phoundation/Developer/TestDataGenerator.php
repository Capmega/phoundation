...
class TestDataGenerator
{
    ...
    {
        return get_null(sql()->getInteger('SELECT `id` FROM `business_providers` ORDER BY RAND() LIMIT 1;'));
    }
    ...
    {
        return get_null(sql()->getInteger('SELECT `id` FROM `business_customers` ORDER BY RAND() LIMIT 1;'));
    }
    ...
    {
        return get_null(sql()->getInteger('SELECT `id` FROM `business_categories` ORDER BY RAND() LIMIT 1;'));
    }
