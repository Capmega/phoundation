...
/**
 * Class RepositoriesNotAllHaveBranchException
 *
 * Thrown when a repository action requires all repositories to have a branch, but not all do
 *
...
class RepositoriesNotAllHaveBranchException extends VersioningException
{
    /**
     * RepositoriesNotAllHaveBranchException class constructor
     *
