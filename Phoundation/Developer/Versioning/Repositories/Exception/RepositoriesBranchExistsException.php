...
/**
 * Class RepositoriesBranchExistsException
 *
 * Thrown when a repository action requires a version branch to not exist, but it already exists
 *
...
class RepositoriesBranchExistsException extends VersioningException
{
    /**
     * RepositoriesBranchExistsException class constructor
     *
