...
/**
 * Class RepositoriesNotAllHaveTagException
 *
 * Thrown when a repository action requires all repositories to have a tag, but not all do
 *
...
class RepositoriesNotAllHaveTagException extends VersioningException
{
    /**
     * RepositoriesNotAllHaveTagException class constructor
     *
