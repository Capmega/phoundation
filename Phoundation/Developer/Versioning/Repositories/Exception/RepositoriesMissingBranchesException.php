...
/**
 * Class RepositoriesMissingBranchesException
 *
 * Thrown when not all repositories have a set of required branches
 *
...
class RepositoriesMissingBranchesException extends VersioningException
{
    /**
