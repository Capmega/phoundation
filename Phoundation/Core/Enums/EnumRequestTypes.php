 ...
 *
 * AJAX:    A client - server API type request, may be REST or GraphQL. Requires a cookie from the user through an HTML
 *          web page
 *
 * API:     An API type request that is made without cookies and requires its own authentication and session handling
 *
 ...
 *
 * OTHER:   Any kind of request that isn't covered by the above list
 *
