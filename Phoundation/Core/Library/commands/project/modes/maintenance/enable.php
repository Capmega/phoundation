...
/**
 * Command project modes maintenance enable
 *
...
CliDocumentation::setUsage('./pho project modes maintenance enable');
...
Disable maintenance mode manually with ./pho project modes maintenance disable
