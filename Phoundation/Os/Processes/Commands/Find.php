    ...
    public function executeReturnArray(): array
    {
        ...
        try {
            $this->setCommand('find')
                 ...
                 ->appendArgument($this->_path->getSource())
                 ->appendArguments($this->max_depth       ? ['-maxdepth', $this->max_depth]              : null)
                 ->appendArguments($this->min_depth       ? ['-mindepth', $this->min_depth]              : null)
                 ->appendArguments($this->mount           ? '-mount'                                     : null)
                 ->appendArguments($this->empty           ? '-empty'                                     : null)
                 ->appendArguments($this->delete          ? ['-delete']                                  : null)
                 ->appendArguments($this->follow_symlinks ? '-L'                                         : null)
                 ->appendArguments($this->name            ? ['-name', $this->name]                   : null)
                 ->appendArguments($this->iname           ? ['-iname', $this->iname]                  : null)
                 ->appendArguments($this->find_path       ? ['-path', $this->find_path->getSource()] : null)
                 ->appendArguments($this->atime           ? ['-amin', $this->atime]                  : null)
                 ->appendArguments($this->ctime           ? ['-cmin', $this->ctime]                  : null)
                 ->appendArguments($this->mtime           ? ['-mmin', $this->mtime]                  : null)
                 ->appendArguments($this->type            ? ['-type', $this->type]                   : null)
                 ->appendArguments($this->regex           ? ['-regex', $this->regex]                  : null)
                 ->appendArguments($this->size            ? ['-size', $this->size]                   : null)
                 ->appendArguments($this->depth           ? ['-depth', $this->depth]                  : null)
                 ->appendArguments($this->size            ? ['-size', $this->size]                   : null)
                 ->appendArguments($this->exec            ? ['-exec', $this->exec, '{}', ';']        : null);
