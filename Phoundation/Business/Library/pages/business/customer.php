...
$customer = Customer::new()->loadThis($get['id']);
...
$buttons = Buttons::new()
                  ->addSaveButton()
                  ->addBackButton(Url::newPrevious('/accounts/customers.html'), true)
                  ->addAuditButton(Url::new('/audit/meta+' . $customer->getMetaId() . '.html'), true);
...
$customer_card = Card::new()
                     ...
                     ->setContent($customer->getHtmlFormObject()->render())
...
$picture = Card::new()
               ...
               ->setContent(Img::new()
                               ->setSrc($customer->getProfilePictureFileObject())
