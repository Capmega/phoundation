 ...
 */
sql_query('ALTER TABLE `databases` CHANGE COLUMN `name` VARCHAR(32) NOT NULL');
...
sql_query('ALTER TABLE `databases` CHANGE COLUMN `replication_status` `replication_status` ENUM("enabled", "enabling", "pausing", "resuming", "preparing", "paused", "disabled", "error") NULL DEFAULT "disabled"');
?>
