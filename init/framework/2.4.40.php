...
sql_query('CREATE TABLE `radius_devices` (`id`           INT(11)                                        NOT NULL AUTO_INCREMENT,
                                          ...
                                          CONSTRAINT `fk_radius_devices_createdby` FOREIGN KEY (`createdby`) REFERENCES `users` (`id`) ON DELETE RESTRICT,
...
sql_query('CREATE TABLE `radius_nas` (`id`           INT(11)                        NOT NULL AUTO_INCREMENT,
                                      ...
                                      CONSTRAINT `fk_radius_nas_createdby` FOREIGN KEY (`createdby`) REFERENCES `users` (`id`) ON DELETE RESTRICT
