...
sql_query('CREATE TABLE `blogs_images` (`id`             INT(11)     NOT NULL AUTO_INCREMENT PRIMARY KEY,
                                        ...
                                        CONSTRAINT `fk_blogs_images_created_by`      FOREIGN KEY (`created_by`)      REFERENCES `users`       (`id`) ON DELETE RESTRICT,
...
sql_query('CREATE TABLE `blogs_comments` (`id`             INT(11)     NOT NULL AUTO_INCREMENT PRIMARY KEY,
                                          ...
                                          CONSTRAINT `fk_blogs_comments_created_by`      FOREIGN KEY (`created_by`)      REFERENCES `users`       (`id`) ON DELETE RESTRICT,
