 ...
 */
sql_foreignkey_exists ('blogs_images', 'fk_blogs_images_created_by'     ,  'ALTER TABLE `blogs_images` DROP FOREIGN KEY `fk_blogs_images_created_by`');
...
sql_foreignkey_exists('blogs_photos', 'fk_blogs_photos_created_by'      , '!ALTER TABLE `blogs_photos` ADD CONSTRAINT `fk_blogs_photos_created_by`      FOREIGN KEY (`created_by`)      REFERENCES `users`       (`id`) ON DELETE RESTRICT;');
